...
# bcftools merge -O v -o bronze_age.all.vcf --file-list vcflist
# 2. remove sites with missingness
bgzip bronze_age.all.vcf
bcftools view -O v -o bronze_age.all.nomiss.vcf -g ^miss bronze_age.all.vcf.gz
