...
covs=(30.1914 18.5181 19.4153 28.6134 17.9824 17.7158 18.9695 18.3544 15.0506 23.666 18.8638 19.6712 17.6318)
targetCoverage=0.1
...
do
    ...
    path2BAM="/mnt/archgen/users/yilei/IBDsim/BAM/$iid.bam"
