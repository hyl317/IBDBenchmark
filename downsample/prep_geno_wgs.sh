...
# for cov in cov1over4 cov1over10;
# do
#     cd ./$cov
#     if [ ! -d batch$b ]; then
#         mkdir batch$b
...
# cd /mnt/archgen/users/yilei/IBDsim/downsample/callIBD/wgs
# for cov in cov5 cov2 cov1 cov3over4 cov1over2 cov1over4 cov1over10;
# do
#     cd ./$cov/batch$b
...
#################################### run IBIS and allow more mismatches ###############################
cd /mnt/archgen/users/yilei/IBDsim/downsample/callIBD/wgs
for cov in cov5 cov2 cov1 cov3over4 cov1over2 cov1over4 cov1over10;
do
    cd ./$cov/batch$b
    ...
    # run IBIS
    /mnt/archgen/users/yilei/bin/ibis/ibis -bfile batch$b -noFamID -o batch$b -min_l 5 -er 0.01
