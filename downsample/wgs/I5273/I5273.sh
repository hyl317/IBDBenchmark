...
#$ -N I5273 #Name of the command that will be listed in the queue
...
# coverage of I5273 is ~18.216x
covs=(cov5 cov2 cov1 cov3over4 cov1over2 cov1over4 cov1over10)
fracs=(0.27448397 0.10979359 0.054896794 0.041172596 0.027448397 0.0137242 0.00548968)
