...
#$ -N glimipse_I3950 #Name of the command that will be listed in the queue
...
############# do trimming ################
trimmedBAM="$id.trim5.bam"
samtools view -b -o $id.ch$ch.bam $path2BAM $ch
/mnt/archgen/users/yilei/bin/bamUtil-master/bin/bam trimBam $id.ch$ch.bam $trimmedBAM -L 5 -R 5
