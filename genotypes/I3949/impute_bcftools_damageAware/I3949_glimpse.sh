...
#$ -N glimipse_I3949 #Name of the command that will be listed in the queue
...
path2BAM="/mnt/archgen/users/yilei/LAI/phasing_experiment/AfanasievoFamily/BAM/I3949.bam"
id=I3949
