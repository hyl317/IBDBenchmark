...
#$ -N glimipse_I6714 #Name of the command that will be listed in the queue
...
path2BAM="/mnt/archgen/users/yilei/LAI/phasing_experiment/AfanasievoFamily/BAM/I6714_7.unclipped.bam"
id=I6714
...
####### set C/T, G/A heterozygote site to missing
python3 /mnt/archgen/users/yilei/IBDsim/removeDeaminationSite.py $OUT | bgzip -c > $id.chr$ch.vcf.gz
bcftools index $id.chr$ch.vcf.gz
rm $OUT
rm $OUT.csi
#################### End of preparing genotype likelihood file ###############
